...
const TRANSLATIONS = {
  cs: {
    ...
    'auth.passwordHint': 'Alespoň 12 znaků, velké i malé písmeno, číslice a symbol.',
    ...
    'auth.errPasswordPolicy':
      'Heslo musí mít alespoň 12 znaků a obsahovat velké i malé písmeno, číslici a symbol.',
  ...
  en: {
    ...
    'auth.passwordHint':
      'At least 12 characters, with an uppercase and a lowercase letter, a number and a symbol.',
    'auth.emailSafetyNote':
    ...
    'auth.errPasswordPolicy':
      'Password must be at least 12 characters and include an uppercase and a lowercase letter, a number and a symbol.',
